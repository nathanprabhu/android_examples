...
//This class handles the Web view fragment for Chicago activity
public class MyDetailFragment extends Fragment {
    ...
    void showWebPage(int index) {
        if (index < 0 || index >= MainActivity.linksArray.length)
            return;
        currentIndex = index;
        webPageItem.getSettings().setJavaScriptEnabled(true);
        webPageItem.loadUrl(MainActivity.linksArray[currentIndex]);
    }
